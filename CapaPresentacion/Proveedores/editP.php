...
if (isset ( $_POST ['submit'] )) {
	...
	$ProveedorBLL->Modificar($proveedorE);
...
<form method="post" action="Proveedores/editP.php" role="form" data-toggle="validator">
	<div class="modal-body">
			...
			<div class='form-group'>
					...
					<input class='form-control' name='nombre' type='text' value="<?php echo $vProveedor[0][1];?>" id='nombre' placeholder='solo letras' required pattern="[A-Za-z &ñáéíóú]*" title="el nombre solo debe contener letras">
			</div>
			<div class='form-group'>
					<label for='precio'>Teléfono:</label>
					<input class='form-control' name='telefono' type='tel' value="<?php echo $vProveedor[0][2];?>" id='telefono' placeholder='ejemplo: 2222-2222' requiered pattern="\d{4}-\d{4}"  title="ejemplo: 2222-2222">
			</div>
			<div class='form-group'>
					<label for='clave'>Dirección:</label>
					<input class='form-control' name='direccion' type='text' value="<?php echo $vProveedor[0][3];?>" id='direccion' placeholder='ejemplo: Alajuela' />
			</div>
